package com.example.zoom_car.carrental.test;

import com.example.zoom_car.carrental.src.model.account.Contact;
import com.example.zoom_car.carrental.src.model.account.LicenseInfo;
...
import com.example.zoom_car.carrental.src.model.vehicle.*;
...
public class TestData {
    ...
    public static VehicleReservation getVehicleReservation(User user) {
        ...
        vehicleReservation.setPickupLocation(
                vehicle.getParkedLocation().getAddress());
        vehicleReservation.setAddonServices(Arrays.asList(getChauffeur()));
